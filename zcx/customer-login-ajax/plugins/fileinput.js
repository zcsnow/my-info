...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            '   {uploadIcon}\n</button>\n',
        tGeneric = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   {content}\n' +
            '   {footer}\n' +
            '</div>\n',
        tHtml = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '    <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
            '       ' + DEFAULT_PREVIEW + '\n' +
            '    </object>\n' +
            '   {footer}\n' +
            '</div>',
        tImage = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <img src="{data}" class="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
            '   {footer}\n' +
            '</div>\n',
        tText = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <div class="file-preview-text" title="{caption}" ' + STYLE_SETTING + '>\n' +
            '       {data}\n' +
            '   </div>\n' +
            '   {footer}\n' +
            '</div>',
        tVideo = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}"' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tAudio = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <audio controls>\n' +
            '       <source src="' + '{data}' + '" type="{type}">\n' +
            '       ' + DEFAULT_PREVIEW + '\n' +
            ...
            '   {footer}\n' +
            '</div>',
        tFlash = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tObject = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
            ...
            '   {footer}\n' +
            '</div>',
        tOther = '<div class="file-preview-frame{frameClass} file-drop-zone" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   ' + DEFAULT_PREVIEW + '\n' +
            '   {footer}\n' +
            '</div>',
    ...
    FileInput.prototype = {
        ...
        getPreviewTemplate: function (t) {
            ...
            [].forEach.call(multi.getElementsByClassName('file-preview-thumbnails'), function (el){
        ...
        previewFile: function (file, theFile, previewId, data) {
            ...
            oImage.onload=function(){
                ...
                var oWdth = oImage.width; 
                if (oWdth < 300 || oHeight < 300) {
                    $('#myModal_warning .modal-body p').text('Please upload iamges larger than 800*800.');
