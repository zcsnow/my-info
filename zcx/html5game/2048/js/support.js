documentWith=$(window).width();
var gridcontentWidth=0.92*documentWith;
var cellSideLength=0.18*documentWith;
var cellSpace=0.04*documentWith;
//alert(documentWith);
...
function getNumBgColor(numBgColor)
{
	switch(numBgColor)
	{
