	...
	function ha(e) {
		function n(e, t, n) {
			...
			if (e && "." === e.charAt(0)) if (t) {
				...
				for (t = 0; t < o; t++) if (s = i[t], "." === s) i.splice(t, 1), t -= 1;
				else if (".." === s) {
		...
		return T = {
			...
			configure: function(e) {
				...
				B(e, function(e, t) {
					...
					t = e.name, e.location && (k.paths[t] = e.location), k.pkgs[t] = e.name + "/" + (e.main || "main2").replace(ja, "").replace(R, "")
				}), B(L, function(e, t) {
				...
				return i = i || {}, V(o, {
					...
					toUrl: function(e) {
						...
						var r, i = e.lastIndexOf("."),
							s = e.split("/")[0];
							//alert(-1 !== i && ("." !== s && ".." !== s || 1 < i) && (r = e.substring(i, e.length), e = e.substring(0, i)), x.nameToUrl(n(e, t && t.id, !0), r, !0));
			...
			nameToUrl: function(e, t, n) {
				...
				//alert(k.urlArgs ? r + ((-1 === r.indexOf("?") ? "?" : "&") + k.urlArgs) : r);
