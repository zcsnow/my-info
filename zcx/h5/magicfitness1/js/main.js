$(function(){
	  ...
	  function startPage(){
		...
		$('.swiper-button-next').addClass('btnFlash1');
		$('.swiper-button-prev').addClass('btnFlash2');
	  }
			  ...
			  success: function(){
				...
				if (usercon=="") {
				  ...
				  return;
			        ...
			        $('.pop-tip-box').hide();
					$('.swiper-button-next').removeClass('btnFlash1');
		  			$('.swiper-button-prev').removeClass('btnFlash2');
					resultFun(sex, selectTime);
					var imgid = "";
					if (sex == 0)
