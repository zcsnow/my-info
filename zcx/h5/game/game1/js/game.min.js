...
var __extends = this.__extends || function(d, b) {
    ...
    return __extends(Block, _super), Object.defineProperty(Block.prototype, "canMove", {get: function() {
            return 1 == this.frmBody || 3 == this.frmBody
        },enumerable: !0,configurable: !0}), Object.defineProperty(Block.prototype, "canRotate", {get: function() {
            return 2 == this.frmBody || 3 == this.frmBody
        },enumerable: !0,configurable: !0}), Object.defineProperty(Block.prototype, "numConnectors", {get: function() {
            return this.conLeft + this.conBtm + this.conRight + this.conTop
        },enumerable: !0,configurable: !0}), Block.prototype.init = function(type, face, top, right, bottom, left, updateFrms) {
        ...
        var tween = this.game.add.tween(this.transform).to({rotation: this.transform.rotation + 90}, 250, null, autoStart, delay);
...
}(Phaser.Sprite), __extends = this.__extends || function(d, b) {
    function __() {
        this.constructor = d
    }
    __.prototype = b.prototype, d.prototype = new __
...
}(Phaser.State), __extends = this.__extends || function(d, b) {
    function __() {
        this.constructor = d
    }
    __.prototype = b.prototype, d.prototype = new __
    ...
    function InGameMenu(game, levelNum) {
        ...
        levelName.x = (320 - levelName.width) / 2, this.add(levelName), this.txtPause = new Phaser.Sprite(this.game, 0, 200, "lang", "game-paused.png"), this.txtPause.x = (320 - this.txtPause.width) / 2, this.add(this.txtPause), this.txtWin = new Phaser.Sprite(this.game, 0, 200, "lang", "level-won.png"), this.txtWin.x = (320 - this.txtWin.width) / 2, this.add(this.txtWin), this.quitBtn = new Phaser.UI.Button(this.game, 40, 265, "ui", this.onQuit, this, "menu-down.png", "menu-out.png", "menu-down.png"), this.add(this.quitBtn), this.replayBtn = new Phaser.UI.Button(this.game, 125, 265, "ui", this.onReplay, this, "replay-down.png", "replay-out.png", "replay-down.png"), this.add(this.replayBtn), this.playBtn = new Phaser.UI.Button(this.game, 210, 265, "ui", this.onPlay, this, "play-down.png", "play-out.png", "play-down.png"), this.add(this.playBtn), this.hide(!1)
    }
    return __extends(InGameMenu, _super), InGameMenu.prototype.onQuit = function() {
        ...
        "undefined" == typeof paused && (paused = !0), this.visible = !0, this.txtPause.visible = paused, this.txtWin.visible = !paused, this.won = !paused, this.quitBtn.input.start(), this.replayBtn.input.start(), this.playBtn.input.start(), paused && pauseMusic()
...
}(Phaser.Group), __extends = this.__extends || function(d, b) {
    function __() {
        this.constructor = d
    }
    __.prototype = b.prototype, d.prototype = new __
    ...
    function LevelName(game, X, Y, levelNum) {
        ...
        this.add(lvlspr);
        var str = "" + levelNum, curX = lvlspr.x + lvlspr.width + 10;
        this._width = lvlspr.width, this._height = lvlspr.height;
        for (var i = 0, len = str.length; len > i; i++) {
            var chr = str[i], chrspr = new Phaser.Sprite(game, curX, Y, "text", "num" + chr + ".png");
            curX += chrspr.width - 5, this._width += chrspr.width - 5, this.add(chrspr)
        }
    }
    return __extends(LevelName, _super), Object.defineProperty(LevelName.prototype, "width", {get: function() {
            return this._width
        },enumerable: !0,configurable: !0}), Object.defineProperty(LevelName.prototype, "height", {get: function() {
            return this._height
        },enumerable: !0,configurable: !0}), Object.defineProperty(LevelName.prototype, "x", {get: function() {
            return this.members[0].x
        },set: function(X) {
            for (var dx = X - this.x, i = 0, len = this.length; len > i; i++)
                this.members[i].x += dx
        },enumerable: !0,configurable: !0}), Object.defineProperty(LevelName.prototype, "y", {get: function() {
            return this.members[0].y
        },set: function(Y) {
            for (var dy = Y - this.y, i = 0, len = this.length; len > i; i++)
                this.members[i].y += dy
        },enumerable: !0,configurable: !0}), LevelName
}(Phaser.Group), __extends = this.__extends || function(d, b) {
    function __() {
        this.constructor = d
    }
    ...
    return __extends(LevelSelect, _super), LevelSelect.prototype.create = function() {
        ...
        for (var numScreens = Math.ceil(this.numLevels / 4), s = 0; numScreens > s; s++)
            this.screen(s);
        this.add.button(this.game.stage.width - 70, 10, "ui", this.home, this, "home-down.png", "home-out.png", "home-down.png"), this.add.existingGroup(new MuteBtn(this.game, 0, 10));
        ...
        var screen_y = 480 * screenNum, fstBtn = 1 + screenNum * this.levelsPerScreen;
        ...
        for (var r = 0; 2 > r; r++)
            for (var c = 0; 3 > c; c++)
                fstBtn <= this.numLevels && this.lvlbtn(fstBtn, 40 + 85 * c, screen_y + 110 + 120 * r), fstBtn++;
        ...
        if (lvlNum - 1 > this.lastLevel)
            return this.ui.add(new Phaser.Sprite(this.game, x, y, "ui", "locked.png"));
        ...
        this.game.add.tween(this).to({Y: this.Y - 480}, 500, Phaser.Easing.Linear.None, !0)
...
}(Phaser.State), levelSelect, __extends = this.__extends || function(d, b) {
    function __() {
        this.constructor = d
    }
    __.prototype = b.prototype, d.prototype = new __
    ...
    function PlayState(game, levelNum) {
        _super.call(this, game), this.gridX = 0, this.gridY = 0, this.grid_numR = 4, this.grid_numC = 4, this.winTime = 0, this.moveSfx = null, this.rotateSfx = null, this.winSfx = null, this.levelNum = levelNum, this.gridX = (game.stage.width - 75 * this.grid_numR) / 2, this.gridY = (game.stage.height - 75 * this.grid_numC) / 2, this.grid = [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null]
    }
    return __extends(PlayState, _super), PlayState.prototype.create = function() {
        this.sound.usingWebAudio && (this.moveSfx = this.add.audio("move"), this.moveSfx.override = !0, this.rotateSfx = this.add.audio("rotate"), this.rotateSfx.override = !0, this.winSfx = this.add.audio("win"), this.winSfx.override = !0), this.game.add.sprite(0, 0, "normal-bg"), this.drawGridBg(), this.add.existingGroup(new LevelName(this.game, 60, 10, this.levelNum + 1)), this.loadLevel(), this.add.button(240, 10, "ui", this.onPause, this, "pause-down.png", "pause-out.png", "pause-down.png"), this.muteBtn = new MuteBtn(this.game, 0, 10), this.add.existingGroup(this.muteBtn), this.inGameMenu = new InGameMenu(this.game, this.levelNum), this.add.existingGroup(this.inGameMenu), this.game.input.onTap.add(this.onTap, this)
        ...
        for (var r = 1; r < this.grid_numR; r++)
            griddt.context.beginPath(), griddt.context.moveTo(75 * r, 0), griddt.context.lineTo(75 * r, griddt.height), griddt.context.stroke();
        for (var c = 1; c < this.grid_numC; c++)
            griddt.context.beginPath(), griddt.context.moveTo(0, 75 * c), griddt.context.lineTo(griddt.width, 75 * c), griddt.context.stroke();
        this.gridbg.texture.setTo(null, griddt)
    }, PlayState.prototype.loadLevel = function() {
        var data = this.game.cache.getText("levels");
        data = data.trim();
        var rows = data.split("\n"), column = rows[this.levelNum].split(","), numBlocks = column.length / 7;
        this.totalConnectors = 0;
        for (var b = 0; numBlocks > b; b++) {
            var type = +column[7 * b].trim(), row = +column[7 * b + 1].trim(), col = +column[7 * b + 2].trim(), top = +column[7 * b + 3].trim(), rig = +column[7 * b + 4].trim(), btm = +column[7 * b + 5].trim(), lft = +column[7 * b + 6].trim(), blk = new Block(this.game);
        ...
        this.won = !0, levelSelect.levelWon(this.levelNum), this.levelNum == levelSelect.numLevels - 1 ? this.game.switchState(new FinishScreen(this.game)) : (this.inGameMenu.show(!1), this.world.group.bringToTop(this.inGameMenu))
    }, PlayState.prototype.dragStart = function(block) {
        this.selected = block
    }, PlayState.prototype.dragStop = function() {
        var ix = this.game.input.x, iy = this.game.input.y, canMove = !0;
        ...
        if (!(this.inGameMenu.visible || this.winTime > 0)) {
            var ix = this.game.input.x, iy = this.game.input.y;
            if (Phaser.SpriteUtils.overlapsXY(this.gridbg, ix, iy)) {
                var row = Math.floor((iy - this.gridY) / 75), col = Math.floor((ix - this.gridX) / 75), blk = this.grid[row * this.grid_numC + col];
        ...
        for (var r = 0; r < this.grid_numR; r++)
            for (var c = 0; c < this.grid_numC; c++)
                blk = this.grid[r * this.grid_numC + c], null != blk && (r > 0 && (nei = this.grid[(r - 1) * this.grid_numC + c], null != nei && nei.conBtm % 2 == blk.conTop % 2 && (this.numConnected += Math.min(nei.conBtm, blk.conTop))), c > 0 && (nei = this.grid[r * this.grid_numC + c - 1], null != nei && nei.conRight % 2 == blk.conLeft % 2 && (this.numConnected += Math.min(nei.conRight, blk.conLeft))));
        this.numConnected == this.totalConnectors && (this.winTime = this.game.time.now)
    }, PlayState.prototype.pauseDrag = function() {
        for (var i = 0, len = this.grid.length; len > i; i++)
            null != this.grid[i] && this.grid[i].canMove && this.grid[i].input.stop();
        this.dragPaused = !0
    }, PlayState.prototype.enableDrag = function() {
        for (var i = 0, len = this.grid.length; len > i; i++)
            null != this.grid[i] && this.grid[i].canMove && this.grid[i].input.start();
        this.dragPaused = !1
...
!function(ConnectMe) {
    var Preloader = function(_super) {
        ...
        return __extends(Preloader, _super), Preloader.prototype.preload = function() {
            this.load.atlas("blocks", "assets/blocks.png", "assets/blocks.xml", null, Phaser.Loader.TEXTURE_ATLAS_XML_STARLING), this.load.atlas("text", "assets/text.png", "assets/text.xml", null, Phaser.Loader.TEXTURE_ATLAS_XML_STARLING), this.load.atlas("ui", "assets/ui.png", "assets/ui.xml", null, Phaser.Loader.TEXTURE_ATLAS_XML_STARLING), this.load.atlas("lang", "assets/lang_en.png", "assets/lang_en.xml", null, Phaser.Loader.TEXTURE_ATLAS_XML_STARLING), this.load.image("start-bg", "assets/bgs/start_screen_withlogo.jpg"), this.load.image("normal-bg", "assets/bgs/background.jpg"), this.load.image("pause-bg", "assets/bgs/pause-bg.jpg"), this.load.image("rotate-bg", "assets/bgs/rotate.jpg"), this.load.image("black-bg", "assets/bgs/black.jpg"), this.load.text("levels", "assets/maps.txt"), this.load.audio("music", ["assets/music/music.ogg", "assets/music/music.mp3"]), 1 == this.sound.usingWebAudio && (this.load.audio("move", ["assets/music/move.mp3"]), this.load.audio("rotate", ["assets/music/rotate.mp3"]), this.load.audio("win", ["assets/music/win.mp3"]))
        }, Preloader.prototype.loadRender = function() {
            var invMul = this.game.stage.width / this.game.stage.scale.width, W = 138 * invMul, H = 10 * invMul, X = (this.game.stage.width - W) / 2, Y = 380, context = this.game.stage.context;
            context.drawImage(this.bg.texture.texture, 0, 0), context.fillStyle = "white", context.fillRect(X, Y, W, H), context.fillStyle = "rgb(254,200,14)", context.fillRect(X, Y, W * this.game.load.progress / 100, H)
...
var __extends = this.__extends || function(d, b) {
    ...
    return __extends(TitleScreen, _super), TitleScreen.prototype.create = function() {
        console.error("TitleScreen"), this.add.sprite(0, 0, "start-bg"), this.game.device.localStorage && null == localStorage.getItem("lastLevel") && localStorage.setItem("lastLevel", "0");
        var btn = this.add.button(0, 320, "lang", this.onPlay, this, "start-down.png", "start-out.png", "start-down.png");
        btn.x = (320 - btn.width) / 2, null == music && (music = this.add.audio("music"), resumeMusic(), music.onResume.add(resumeMusic, this)), this.add.existingGroup(new MuteBtn(this.game, 0, 10))
    ...
    return __extends(Tuto1, _super), Tuto1.prototype.create = function() {
        ...
        var tween1 = this.game.add.tween(this.hand).to({x: this.block1.x}, 500, null, !0, 500), tween2 = this.game.add.tween(this.block1).to({x: this.block2.x - 75,y: this.block2.y}, 500, null, !1, 500);
        ...
        var tween3 = this.game.add.tween(this.hand).to({x: this.block3.x,y: this.block3.y + 20}, 500, null, !1, 500);
        tween2.chain(tween3);
        var tween4 = this.game.add.tween(this.block3).to({x: this.block2.x + 75,y: this.block2.y}, 500, null, !1, 500);
    ...
    return __extends(Tuto2, _super), Tuto2.prototype.create = function() {
        this.add.sprite(0, 0, "normal-bg"), this.game.add.sprite(0, 0, "lang", "tuto2-txt.png"), this.block = new Block(this.game, this.game.stage.centerX, 260).init(2, 2, 3, 2, 0, 1), this.add.existingSprite(this.block), this.hand = this.add.sprite(this.game.stage.centerX, 200, "ui", "hand-cursor.png"), this.hand.transform.origin.setTo(.5, .5), this.game.add.tween(this.hand).to({y: this.block.y}, 500, null, !0, 500).onComplete.add(function() {
    ...
    return __extends(Tuto3, _super), Tuto3.prototype.create = function() {
        this.add.sprite(0, 0, "normal-bg"), this.game.add.sprite(0, 0, "lang", "tuto3-txt.png"), this.block = new Block(this.game, 200, 200).init(3, 2, 3, 2, 0, 1), this.add.existingSprite(this.block), this.hand = this.add.sprite(100, 200, "ui", "hand-cursor.png"), this.hand.transform.origin.setTo(.5, .5), this.game.add.tween(this.hand).to({x: this.block.x,y: this.block.y + 20}, 500, null, !0, 500).onComplete.add(function() {
            this.tween1Ended = this.game.time.now
        }, this)
    }, Tuto3.prototype.update = function() {
        if (this.tween1Ended > 0 && this.game.time.elapsedSince(this.tween1Ended) >= 500) {
            this.tween1Ended = 0;
            var tween2 = this.game.add.tween(this.block).to({x: this.game.stage.centerX,y: 300}, 500);
            tween2.onStart.add(function() {
                this.hand.frameName = "hand-cursor-move.png"
            }, this), tween2.onUpdate.add(function() {
            ...
            this.tween2Ended > 0 && this.game.time.elapsedSince(this.tween2Ended) >= 500 ? (this.tween2Ended = 0, this.block.cw_rotate().onComplete.add(function() {
    ...
    var Utils = function() {
        ...
        return Utils.pastSprite = function(dt, sprite, x, y) {
            if ("undefined" == typeof x && (x = 0), "undefined" == typeof y && (y = 0), !(0 == sprite.transform.scale.x || 0 == sprite.transform.scale.y || sprite.texture.alpha < .1)) {
                var _ga = -1, _sx = 0, _sy = 0, _sw = sprite.texture.width, _sh = sprite.texture.height, _dx = x, _dy = y, _dw = sprite.texture.width, _dh = sprite.texture.height;
            ...
            bg.alpha = 0, game.add.tween(bg).to({alpha: 1}, 500, null, !0).onComplete.add(function() {
