...
var year = 2008, time = 800, duration = 1.5;  
function yearAni() {
	if(year > 2017){
		return false;
	}else if(year === 2017){
...
function page5(){
	...
	setTimeout(function(){
		$('.page5 .ele2').addClass("fadeIn animated");
	},500);
	setTimeout(function(){
		$('.page5 .ele3').addClass("fadeIn animated");
	},750);
	setTimeout(function(){
		$('.page5 .ele4').addClass("fadeIn animated");
	},1000);
	setTimeout(function(){
		$('.page5 .ele5').addClass("fadeIn animated");
...
$('.page3 .btn').on('click',function(){
	...
	setTimeout(function(){
		...
		$('.brush-box').removeClass('brushIcon');
		$('.brush-box').hide();
		$("#media").attr('src','images/music2.mp3');
		$("#media")[0].play();
		$('.page4').show();
...
var clickNum = 1;
var flag = 1;
$('.game-txt-list').on('click','li',function(e){
	if(flag == 1){
	flag = 0
	...
	if(clickNum==1){
		...
		if(num==1){
			...
			dataNameShare = "给力2017！" + userName + dataName1 + "、" + dataName2 + "刷新自己~你呢？";
			//popTip(dataTxt);
			/*var sharLink = window.location.href; 
				var shareInfo = {
				title:'刷新自己，给力2017',     
				desc:'2017年刷新自己,'+dataNameShare,
				linetitle:'2017年刷新自己,'+dataNameShare,
				imgUrl:'http://h5.hyh6.com/CompanyProject/GeelyRefresh/images/share_icon.png', 
			}; 
			wxShare(sharLink,shareInfo);*/
			console.log(dataName);
			console.log(dataNameShare);
		...
		dataNameShare = "给力2017！" + userName + dataName1 + "、" + dataName2 + "、" + dataName3 + "刷新自己~你呢？";
		//popTip(dataTxt);
		/*var sharLink = window.location.href; 
			var shareInfo = {
		    title:'刷新自己，给力2017',     
