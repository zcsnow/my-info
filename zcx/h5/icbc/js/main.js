                ...
                if ((i = arguments[t]) != null )
                    for (var s in i) {
                        var o = e[s]
                          , u = i[s];
                        if (e === u)
                            continue;r && u && typeof u == "object" && !u.nodeType ? e[s] = this.objExtend(r, o || (u.length != null  ? [] : {}), u) : u !== undefined && (e[s] = u)
                    }
            return e
        },
        getJson: function(t) {
            ...
            if (typeof t == "object")
                if (t.length != undefined) {
                    ...
                    for (var n = 0, r = t.length; n < r; n++) {
                        if (t[n] === undefined)
                            continue;t[n] != null  && typeof t[n] == "object" ? t[n].length != undefined ? e[n] = t[n].slice(0) : e[n] = t[n] : e[n] = t[n]
                    }
                } else {
                    e = {};
                    for (var n in t) {
    ...
    return {
        init: function() {
            ...
            e.run(function() {
                ...
                e.buttonLayout.released("difficulty1") ? (l.moduleName = "我的成绩",
                hideAd(),
				...
				e.buttonLayout.released("help") && help_text() 
				
            }
            ).zone(function() {
				$('.music').hide();
				$("#media")[0].pause();
                e.canvas.fillStyle("#F00").fillScreen().fillStyle("#FFF").drawString(l.moduleName, 0, u + 110, e.graphics.VCENTER, !1, null , null , "50px 微软雅黑").drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 140, 480, 7).drawImage("btns1", 0, 106, 480, 7, i - 480 >> 1, u + 555, 480, 7).fillStyle("#000").drawString(a(l.time, "秒"), 0, u + 340, e.graphics.VCENTER, !1, null , null , "60px 微软雅黑").fillStyle("#000").drawString("最佳:" + a(l.bestTime, "秒"), 0, u + 400, e.graphics.VCENTER, !1, null , null , "30px 微软雅黑").fillStyle("#000").drawString("成绩斐然，工行融易购手机流量电子卷为你加油", 0, u + 460, e.graphics.VCENTER, !1, null , null , "24px 微软雅黑")/*.fillStyle("#000").drawString("马上抽取", 0, u + 520, e.graphics.VCENTER, !1, null , null , "30px 微软雅黑")*/,
