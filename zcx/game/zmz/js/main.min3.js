...
shareData = {
    imgUrl: "http://i3.7k7kimg.cn/cms/cms10/20140804/171759_6853.jpg",
    timeLineLink: "http://flash.7k7k.com/h5/weixin/meizi/game.htm",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://www.7k7k.com/m-android/play/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://www.7k7k.com/m-android/play/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
...
function() {
    ...
    e = {
        ...
        render: function(e, f) {
            ...
            a.find(b).css("background-color", i[1]).data("type", "b").html('<span style="padding:0px;border:0;font-size:'+size+'px;line-height:'+size+'px;width:100%;height:100%" >男</span>'),
            a.find(b).eq(h).css("background-color", i[1]).data("type", "a").html('<span style="padding:0px;border:0;font-size:'+size+'px;line-height:'+size+'px;width:100%;height:100%" >女</span>')
        },
        getColor: function(a) {
